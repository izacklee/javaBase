...
/*
    文件上传案列服务器：读取客户端上传的文件，保存到服务器的硬盘，给客户端回写“上传成功”

    明确：
        数据源：客户端上传的文件
        目的地：服务器的硬盘 advance/src/cn/itcast/day11/test/upload/newin.txt
...
public class TCPServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 5.创建一个本地字节输出流FileOutputStream对象，构造方法中绑定要输出的目的地
        FileOutputStream fos = new FileOutputStream("advance/src/cn/itcast/day11/test/upload/newin.txt");
        // 6.使用网络字节输入流InputStream对象中的方法read，读取客户端上传的文件
