package com.zeroten.javales.day75c_springprinciple;
...
public class JDKDynamicProxyTest {
    ...
    public static void main(String[] args) {
        ...
        ProxyTestInterface proxyTestInterface = (ProxyTestInterface) Proxy.newProxyInstance(
                proxyTest.getClass().getClassLoader(), ProxyTest.class.getInterfaces(), handler);
