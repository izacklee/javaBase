            ...
            if (hc != null) {
                ...
                if (mv != null) {
                    if (!mv.isRest()) {
                        ...
                        hres.setHeader("Access-Control-Request-Method", "PUT,POST,GET,DELETE,OPTIONS");
                        hres.setHeader("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Accept, t");
